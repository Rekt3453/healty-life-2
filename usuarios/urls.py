...
urlpatterns = [
    ...
    path('dashboard/gerente/crear-consultorio/', views.crear_consultorio, name='crear_consultorio'),
    path('dashboard/gerente/registrar-pago-recepcionista/', views.registrar_pago_recepcionista, name='registrar_pago_recepcionista'),
