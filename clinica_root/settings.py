...
if not SECRET_KEY:
    raise ValueError("SECRET_KEY no está definida en las variables de entorno. Agrégala al archivo .env")
...
CORS_ALLOW_ALL_ORIGINS = DEBUG  # True solo en desarrollo; False en producción
