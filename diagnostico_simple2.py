...
try:
    with connection.cursor() as c:
        c.execute("SELECT column_name, data_type, is_nullable FROM information_schema.columns WHERE table_name = 'usuarios_userprofile' ORDER BY ordinal_position")
...
try:
    with connection.cursor() as c:
        c.execute("SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'estados'")
        print('\n=== estados ===')
        for row in c.fetchall():
            print(row)
except Exception as e:
...
try:
    with connection.cursor() as c:
        c.execute("SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'municipios'")
        print('\n=== municipios ===')
        for row in c.fetchall():
            print(row)
except Exception as e:
...
try:
    with connection.cursor() as c:
        c.execute("SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'ciudades'")
        print('\n=== ciudades ===')
        for row in c.fetchall():
            print(row)
except Exception as e:
...
try:
    with connection.cursor() as c:
        c.execute("SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'parroquias'")
        print('\n=== parroquias ===')
        for row in c.fetchall():
            print(row)
except Exception as e:
